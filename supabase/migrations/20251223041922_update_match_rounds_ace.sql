-- Updated function to handle all ceremony types
...
begin
  ...
  where
    ...
    and (filter_round_type is null or re.round_type = filter_round_type) -- This now correctly matches 'ace', 'thrifty', etc.
